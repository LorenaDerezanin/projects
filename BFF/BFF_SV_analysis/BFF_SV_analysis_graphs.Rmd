...
# prep SV coordinates
SV_elements <- select(BFF_gene_count, SV_type, Chr, SV_start, SV_end) 

write.table(SV_elements, "input_data/SV_elements.txt", sep = "\t", col.names = F, row.names = F) 



chromoMap("input_data/Chr_elements.txt","input_data/SV_elements.txt", segment_annotation = T)
