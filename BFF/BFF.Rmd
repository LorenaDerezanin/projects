...
# transform ferrets GO ids to terms
library(GO.db)



# semantic similarity analysis between 2 GO term sets
# GOSemSim::mgoSim()

# build dom.fer. and bff eg.db
# transform biol. processes col into list of GO terms
