...
# find r pkg for GO terms and biol.processes analysis
# semantic similarity analysis and word clouds
# clusterProfiler: cnetplot function, enrichment map
# pmcplot - query pubmed central for GO descriptions in publications, serves for other query types also
